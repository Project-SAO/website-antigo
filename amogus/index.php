      ...
      <div class="mask" style="background-color: rgba(0, 0, 0, 0.8);">
        <div class="container d-flex align-items-center justify-content-center text-center h-100">
          <div class="text-white">
            ...
            <h5 class="mb-2">In this website, you can find everything you need to join our project.</h5>
            <h5 class="mb-2">If you need any kind of help, contact our support at: fca.10.fa@gmail.com
          </div>
        </div>
      </div>
    </div>
